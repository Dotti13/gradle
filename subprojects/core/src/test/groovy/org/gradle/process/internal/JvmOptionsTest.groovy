...
class JvmOptionsTest extends Specification {
    ...
    private JavaForkOptions newJavaForkOptions() {
        return objectFactory.newInstance(DefaultJavaForkOptions, objectFactory, pathToFileResolver, fileCollectionFactory, new DefaultJavaDebugOptions(fileCollectionFactory))
    }
