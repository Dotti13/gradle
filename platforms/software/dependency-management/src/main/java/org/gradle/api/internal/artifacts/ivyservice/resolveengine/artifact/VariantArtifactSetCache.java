...
public class VariantArtifactSetCache {
     ...
     */
    public ArtifactSet computeIfAbsent(ComponentGraphResolveState component, VariantGraphResolveState variant) {
        return cache.computeIfAbsent(variant.getInstanceId(), id -> new VariantResolvingArtifactSet(
            component,
            variant,
